...
let overview =
    Html.div [
        Bulma.title.h1 [
            Html.text "Fable.ReactAgGrid - Documentation"
            Html.a [
        ...
        Shared.fixDocsView "Fable.AgGrid" false
    ]

let installation = Shared.installationView "Fable.ReactAgGrid"
