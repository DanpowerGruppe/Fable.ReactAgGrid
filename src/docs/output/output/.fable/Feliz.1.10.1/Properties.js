...
import { printf as String_printf, toText as String_toText, join as String_join } from "../../../.fable/fable-library.3.0.0-nagareyama-beta-003/String.js";
                    ...
                    switch (pattern_matching_result_2) {
                        ...
                        case 1: {
                            ...
                            switch (pattern_matching_result_3) {
                                case 0: {
                                    if (pressedKey.toLocaleLowerCase() === ev.key.toLocaleLowerCase()) {
                                        handler(ev);
                                    }
                                    break;
                                }
