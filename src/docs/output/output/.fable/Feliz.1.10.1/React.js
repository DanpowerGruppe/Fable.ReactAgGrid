import { useLayoutEffectWithDeps as ReactInterop_useLayoutEffectWithDeps_1, useLayoutEffect as ReactInterop_useLayoutEffect_1, useEffectWithDeps as ReactInterop_useEffectWithDeps_1, useEffect as ReactInterop_useEffect_1, useDebugValue as ReactInterop_useDebugValue } from "../../../.fable/Feliz.1.10.1/ReactInterop.js";
...
export function React_useEffect_Z4935BE6B(effect) {
    ReactInterop_useEffect(effect);
}

export function React_useEffect_Z5CB81B8(effect, dependencies) {
    ReactInterop_useEffectWithDeps(effect, dependencies);
}

export function React_useLayoutEffect_Z4935BE6B(effect) {
    ReactInterop_useLayoutEffect(effect);
}

export function React_useLayoutEffect_Z5CB81B8(effect, dependencies) {
...
export function React_useLayoutEffect_Z101E1A95(effect, dependencies) {
    ReactInterop_useLayoutEffect((_arg2) => {
        effect();
        return React_createDisposable_3A5B6456(() => {
            void undefined;
        });
...
export function React_useLayoutEffectOnce_3A5B6456(effect) {
    React_useLayoutEffect_Z101E1A95(effect, []);
}

export function React_useLayoutEffectOnce_Z4935BE6B(effect) {
    React_useLayoutEffect_Z5CB81B8(effect, []);
}
...
export function React_useEffectOnce_Z4935BE6B(effect) {
    React_useEffect_Z5CB81B8(effect, []);
}

export function React_useEffectOnce_Z3718DFC0(effect) {
    React_useEffect_Z5CB81B8(() => {
