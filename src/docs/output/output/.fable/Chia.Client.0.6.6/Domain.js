...
export function Logging_DevOption$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Logging.DevOption", [], Logging_DevOption, () => [[], [], []]);
}
...
export function Config_DevStatus$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Config.DevStatus", [], Config_DevStatus, () => [[], [], [], []]);
}
...
export class Time_ReportIntervall extends Types_Union {
    ...
    cases() {
        return ["Dayly", "Weekly", "Monthly", "Quarterly", "Halfyearly", "Yearly"];
    }
}

export function Time_ReportIntervall$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Time.ReportIntervall", [], Time_ReportIntervall, () => [[], [], [], [], [], []]);
}
...
export function Time_TimeFilters$reflection() {
    return Reflection_record_type("Chia.Client.Domain.Time.TimeFilters", [], Time_TimeFilters, () => [["StartDate", Reflection_string_type], ["StartDateLeavingPlants", Reflection_string_type], ["EndDate", Reflection_string_type], ["EndDateLeavingPlants", Reflection_string_type], ["EndDateMinusOneDay", Reflection_option_type(Reflection_string_type)], ["StartVuPeriode", Reflection_int32_type], ["EndVuPeriode", Reflection_int32_type], ["EndVuPeriodeLast", Reflection_option_type(Reflection_int32_type)], ["EndVuPeriodeQuotes", Reflection_int32_type]]);
}
...
export function Time_TimeSpans$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Time.TimeSpans", [], Time_TimeSpans, () => [[], [], [], [], [], []]);
}
...
export function Time_Aggregation$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Time.Aggregation", [], Time_Aggregation, () => [[], []]);
}
...
export function Time_TimeModel$reflection() {
    return Reflection_record_type("Chia.Client.Domain.Time.TimeModel", [], Time_TimeModel, () => [["ReportIntervall", Time_ReportIntervall$reflection()], ["DateStart", Reflection_class_type("System.DateTimeOffset")], ["DateEnd", Reflection_class_type("System.DateTimeOffset")]]);
}
...
export function Selection$1$reflection(gen0) {
    return Reflection_record_type("Chia.Client.Domain.Selection`1", [gen0], Selection$1, () => [["Value", gen0], ["Text", Reflection_string_type]]);
}
...
export function Ids_ReportId$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Ids.ReportId", [], Ids_ReportId, () => [[["reportId", Reflection_int32_type]]]);
}
...
export function Ids_SortableRowKey$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Ids.SortableRowKey", [], Ids_SortableRowKey, () => [[["Item", Reflection_string_type]]]);
}
...
export function SortableRowKey_toRowKey(dateTime) {
    let copyOfStruct;
...
export function SortableRowKey_toDate(_arg1) {
    let copyOfStruct;
...
export function Tables_TableEntity$reflection() {
    return Reflection_union_type("Chia.Client.Domain.Tables.TableEntity", [], Tables_TableEntity, () => [[["Item", Reflection_string_type]], [["Item", Reflection_float64_type]], [["Item", Reflection_int32_type]]]);
}
...
export function Tables_TableRecord$reflection() {
    return Reflection_record_type("Chia.Client.Domain.Tables.TableRecord", [], Tables_TableRecord, () => [["Header", Reflection_array_type(Tables_TableEntity$reflection())], ["Content", Reflection_array_type(Reflection_array_type(Tables_TableEntity$reflection()))]]);
}
