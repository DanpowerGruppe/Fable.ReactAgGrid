import { Option as Image_Option, image as Image_image } from "../Fulma.2.9.0/Elements/Image.js";
...
import { Size_ISize as Common_Size_ISize, Color_IColor as Common_Color_IColor, Modifier_IModifier as Common_Modifier_IModifier, TextAlignment_Option$reflection as Common_TextAlignment_Option$reflection, Screen$reflection as Common_Screen$reflection } from "../Fulma.2.9.0/Common.js";
import { select as Select_select } from "../Fulma.2.9.0/Elements/Form/Select.js";
...
import { HTMLAttr as Fable$002EReact$002EProps_HTMLAttr } from "../Fable.React.6.2.0/Fable.React.Props.js";
...
import { Browser_Types_Event__Event_get_Value as Fable$002EReact$002EExtensions_Browser_Types_Event__Event_get_Value } from "../Fable.React.6.2.0/Fable.React.Extensions.js";
import { Option as Control_Option, div as Control_div } from "../Fulma.2.9.0/Elements/Form/Control.js";
import { Option as Label_Option, label as Label_label } from "../Fulma.2.9.0/Elements/Form/Label.js";
import { printf as String_printf, toText as String_toText } from "../../../.fable/fable-library.3.0.0-nagareyama-beta-003/String.js";
import { Option as Notification_Option, notification as Notification_notification } from "../Fulma.2.9.0/Elements/Notification.js";
import { Option as Button_Option, button as Button_button } from "../Fulma.2.9.0/Elements/Button.js";
import { Item_a as Menu_Item_a, Item_Option as Menu_Item_Option, Item_li as Menu_Item_li } from "../Fulma.2.9.0/Components/Menu.js";
import { Option as Icon_Option, icon as Icon_icon } from "../Fulma.2.9.0/Elements/Icon.js";
import { Fa_i as FontAwesome_Fa_i } from "../Fable.FontAwesome.2.0.0/FontAwesome.js";
import { IInputType as Input_IInputType, Option as Input_Option, input as Input_input } from "../Fulma.2.9.0/Elements/Form/Input.js";
...
export function Types_Selection$1$reflection(gen0) {
    return Reflection_record_type("Chia.Client.Types.Selection`1", [gen0], Types_Selection$1, () => [["Value", gen0], ["Text", Reflection_string_type]]);
}
...
export function Types_SelectionInformation$reflection() {
    return Reflection_record_type("Chia.Client.Types.SelectionInformation", [], Types_SelectionInformation, () => [["Label", Reflection_string_type], ["DefaultDataLabel", Reflection_string_type], ["NoDataLabel", Reflection_string_type], ["Alignment", Reflection_tuple_type(Common_Screen$reflection(), Common_TextAlignment_Option$reflection())]]);
}
