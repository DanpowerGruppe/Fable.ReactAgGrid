...
function RouterModule_normalizeRoute(routeMode) {
    if (routeMode === 1) {
        return (_arg1) => {
            let activePatternResult12600, path, activePatternResult12601, path_1, activePatternResult12602, path_2, path_3;
            return activePatternResult12600 = RouterModule_String_$007CPrefix$007C("/", _arg1), (activePatternResult12600 != null) ? (path = activePatternResult12600, "#" + path) : (activePatternResult12601 = RouterModule_String_$007CPrefix$007C("#/", _arg1), (activePatternResult12601 != null) ? (path_1 = activePatternResult12601, path_1) : (activePatternResult12602 = RouterModule_String_$007CPrefix$007C("#", _arg1), (activePatternResult12602 != null) ? (path_2 = activePatternResult12602, "#/" + String_substring(path_2, 1, path_2.length - 1)) : (path_3 = _arg1, "#/" + path_3)));
        };
    }
    else {
        return (_arg2) => {
            let activePatternResult12605, path_4, path_5;
            return activePatternResult12605 = RouterModule_String_$007CPrefix$007C("/", _arg2), (activePatternResult12605 != null) ? (path_4 = activePatternResult12605, path_4) : (path_5 = _arg2, "/" + path_5);
        };
    }
}
...
export function RouterModule_urlSegments(path, mode) {
    let activePatternResult12621, activePatternResult12616, activePatternResult12617;
    let list;
    let array;
    const str = (activePatternResult12621 = RouterModule_String_$007CPrefix$007C("#", path), (activePatternResult12621 != null) ? String_substring(path, 1, path.length - 1) : ((mode === 1) ? (activePatternResult12616 = RouterModule_String_$007CSuffix$007C("#", path), (activePatternResult12616 != null) ? "" : (activePatternResult12617 = RouterModule_String_$007CSuffix$007C("#/", path), (activePatternResult12617 != null) ? "" : path)) : path));
    ...
    return List_collect((segment) => {
        if (String_isNullOrWhiteSpace(segment)) {
            ...
            if (segment_1 === "?") {
                ...
                const activePatternResult12623 = RouterModule_String_$007CPrefix$007C("?", segment_1);
                if (activePatternResult12623 != null) {
