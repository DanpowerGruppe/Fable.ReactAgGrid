                    ...
                    if ((Reflection_fullName(keyType) === "System.String") ? true : (Reflection_fullName(keyType) === "System.Guid")) {
                        return (value_12) => {
                            ...
                            return Seq_fold((target, _arg1) => {
                                const activePatternResult16830 = _arg1;
                                const v_1 = activePatternResult16830[1];
                                const k = activePatternResult16830[0];
                        ...
                        return (value_13) => {
                            ...
                            values_4 = Seq_map((_arg2) => {
                                const activePatternResult16834 = _arg2;
                                const v_2 = activePatternResult16834[1];
                                const k_1 = activePatternResult16834[0];
