                    ...
                    if ((Reflection_fullName(keyType) === "System.String") ? true : (Reflection_fullName(keyType) === "System.Guid")) {
                        return (value_12) => {
                            ...
                            return Seq_fold((target, _arg1) => {
                                const activePatternResult16652 = _arg1;
                                const v_1 = activePatternResult16652[1];
                                const k = activePatternResult16652[0];
                        ...
                        return (value_13) => {
                            ...
                            values_4 = Seq_map((_arg2) => {
                                const activePatternResult16656 = _arg2;
                                const v_2 = activePatternResult16656[1];
                                const k_1 = activePatternResult16656[0];
