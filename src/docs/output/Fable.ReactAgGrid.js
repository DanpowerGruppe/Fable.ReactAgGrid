...
import { union_type as Reflection_union_type, option_type as Reflection_option_type, array_type as Reflection_array_type, int32_type as Reflection_int32_type, lambda_type as Reflection_lambda_type, unit_type as Reflection_unit_type, class_type as Reflection_class_type, bool_type as Reflection_bool_type, float64_type as Reflection_float64_type, obj_type as Reflection_obj_type, record_type as Reflection_record_type, string_type as Reflection_string_type } from "./.fable/fable-library.3.0.0-nagareyama-beta-003/Reflection.js";
...
export function ColumnDef(options) {
    return MapUtil_keyValueList(options, 1, true);
}
