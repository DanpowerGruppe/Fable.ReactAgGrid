...
export function Highlight$reflection() {
    return Reflection_class_type("Shared.Highlight", void 0, Highlight);
}
...
export function fixDocsView(fileName, client) {
    let xs, value, arg10, clo1, value_1;
    const children = List_singleton((xs = List_ofArray([(value = (arg10 = fileName, (clo1 = String_toText(String_printf("https://github.com/DanpowerGruppe/Fable.AgGrid/tree/master/src/docs/views/FableAgGrid/%s.fs")), clo1(arg10))), Interop_mkAttr("href", value)), (value_1 = (("Fix docs file " + fileName) + " here"), Interop_mkAttr("children", value_1))]), Interop_reactElement("a", Util_createObjDebug(xs))));
