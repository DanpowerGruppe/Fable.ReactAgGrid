...
let gitName = "Fable.ReactAgGrid"

// The name of the project
// (used by attributes in AssemblyInfo, name of a NuGet package and directory in 'src')
let project = "Fable.ReactAgGrid"
...
let description = """Fable bindings for AgGrid."""
// List of author names (for NuGet package)
let authors = [ "Tim Forkmann"]
let owner = "Tim Forkmann"
// Tags for your project (for NuGet package)
let tags = "FableBinding Danpower"
...
Target.create "Pack" (fun _ ->
    ...
    let pack project =
        let projectPath = sprintf "src/%s.fsproj" project
        let args =
